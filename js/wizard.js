    ...
    <div class="field-row">
      <div class="field">
        ...
        <div class="color-field">
          <input type="color" id="fThemeColor" value="${escapeHtml(normalizeHex(state.themeColor) || "#000000")}">
          <input type="text" id="fTheme" value="${escapeHtml(state.themeColor)}">
        </div>
      </div>
      <div class="field">
        <label for="fBg">Background color <span style="font-weight:400;color:var(--ink-faint);">, splash screen</span></label>
        <div class="color-field">
          <input type="color" id="fBgColor" value="${escapeHtml(normalizeHex(state.bgColor) || "#ffffff")}">
          <input type="text" id="fBg" value="${escapeHtml(state.bgColor)}">
        </div>
      </div>
    </div>
    <div class="step-actions">
