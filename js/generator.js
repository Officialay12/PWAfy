...
// Generates a real VAPID keypair (P-256 ECDSA) client-side via Web Crypto —
// nothing is sent anywhere to produce these, same as every other file this
...
be used to send push notifications to every subscriber on your behalf —
treat it exactly like an API secret.
