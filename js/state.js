...
const state = {
  ...
  screenshots: [], // [{img, dataUrl, formFactor, width, height}]
  includePush: false,
  customAttribution: "", // agency-plan white-label override for README/footer
};

// Shared between wizard.js (declares dimensions in the manifest at upload
// time) and generator.js (does the actual canvas resize at build time) so
